			...
			<Grid container>
					...
					<Grid item xl={4} lg={4} md={4} style={{ background: '#ECE4BA', padding: '10px' }}>
						<Paper square>
							<img
								...
								alt="animal"
								src={currentAnimal.data !== undefined ? currentAnimal.data.image1 : null}
							/>
						</Paper>
					</Grid>
					...
					<Grid item xl={4} lg={4} md={4} style={{ background: '#ECE4BA', padding: '10px' }}>
						<Paper square>
							<img
								className={classes.image}
								alt="animal"
								src={currentAnimal.data !== undefined ? currentAnimal.data.image2 : null}
							/>
						</Paper>
					</Grid>
					...
					<Grid item xl={4} lg={4} md={4} style={{ background: '#ECE4BA', padding: '10px' }}>
						<Paper square>
							<img
								className={classes.image}
								alt="animal"
								src={currentAnimal.data !== undefined ? currentAnimal.data.image3 : null}
							/>
						</Paper>
					</Grid>
				</Hidden>
				...
				<Grid container justify="center">
					<Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
						<Link to={`/animal-adopt-3/${id}`} style={{ textDecoration: 'none', color: '#6C5434' }}>
							<Button
								disabled={status === true ? false : true}
								variant="contained"
								color="inherit"
						...
						<Link to="/our-animals" style={{ textDecoration: 'none', color: '#6C5434' }}>
							<Button
								variant="contained"
								color="inherit"
								style={{
						...
						<Paper square>
							<div>
								<img
									...
									src="https://images-na.ssl-images-amazon.com/images/I/91Oc19qjgyL._AC_SX425_.jpg"
								/>
							</div>
							<Typography
								style={{
					...
					<Grid item sm={12} xs={12} lg={3} style={{ background: 'transparent', margin: '0px' }}>
						<Paper square>
							<div>
								<img
									className={classes.img}
									src="https://dbdzm869oupei.cloudfront.net/img/sticker/large/7599.jpg"
								/>
							</div>
							<Typography
								style={{
					...
					<Grid item sm={12} xs={12} lg={3} style={{ background: 'transparent', margin: '0px' }}>
						<Paper square>
							<div>
								<img
									className={classes.img}
									src="https://covers.magazinecloner.com/covers/157365.jpg"
								/>
							</div>
							<Typography
								style={{
					...
					<Grid item sm={12} xs={12} lg={3} style={{ background: 'transparent', margin: '0px' }}>
						<Paper square>
							<div>
								<img
									className={classes.img}
									src="https://cdn.cp.adobe.io/content/2/rendition/3901fe78-2416-4023-84a5-0ed4eb282c5f/artwork/5fa3a90a-2b08-43f0-82ef-cff446f38ff1/version/0/format/jpg/dimension/width/size/300"
								/>
							</div>
							<Typography
								style={{
